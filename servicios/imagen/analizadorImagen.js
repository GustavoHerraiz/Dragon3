...
class GestorStreamsBidireccionalFAANG {
    ...
    async cargarAnalizadores() {
        ...
        try {
            const directorioAnalizadores = path.join('/var/www/Dragon3/backend/servicios/imagen/analizadores');
            ...
            dragon.agoniza('Error cargando analizadores FAANG', error, 'analizadorImagen', 'ANALYZERS_LOAD_FAILED', {
                duration: Math.round(duration * 100) / 100,
                directorio: '/var/www/Dragon3/backend/servicios/imagen/analizadores'
            });
